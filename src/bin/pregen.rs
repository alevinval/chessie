...
fn print_file() {
    ...
    println!("/// This file is auto-generated by `cargo run --bin chessie-pregen`.");
    println!("");
    println!("use crate::defs::BitBoard;");
    println!("");
    println!("pub struct MagicMovements;");
    println!("");
    println!("#[allow(dead_code)]");
    println!("#[allow(clippy::unreadable_literal)]");
    println!("impl MagicMovements {{");
    println!("");
